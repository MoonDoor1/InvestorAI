...
questions = [
    "Have there been any significant investments or exits this quarter?",
    "Were there any adjustments made to marks or cap rates this quarter, and if so, what were the primary reasons provided?",
    "Are there any details on the current loan size or balance?", #good question 
    "Are there any plans or strategies indicated to bring down the loan or engage in converting it?",
    "Were there any major financial losses reported this quarter?",
    "Were there any instances where there was a full loss of equity?",
    "If there were major losses, which assets or investments were primarily affected?",
    "How does the performance this quarter compare to the last quarter?", #no results potentailly due to small sample size
    "What is the overall health and performance trajectory of the fund or company?", #good question
    "Are there any strategic shifts or major decisions indicated in light of the current financial performance?",
    "What external factors have been cited as affecting performance this quarter?", # good question
    "Are there any risks or concerns highlighted that could impact future performance?"# good question 
]

# New questions
questions += [
    "What are the key loan metrics highlighted in the report for this quarter?",
    "Have there been any significant changes in the loan metrics compared to the previous quarter?",
    "What is the average interest rate of the loans outlined in the report?",
    "Can you detail the loan maturity schedule as provided in the report?",
    "How many loans are set to mature in the next quarter? And in the next year?",
    "Are there any concerns or notes regarding refinancing or renewals of maturing loans?",
    "What properties have been newly invested in this quarter?",
    "Are there any properties that have been divested or exited this quarter?",
    "What are the top-performing properties based on the investment summaries?",
    "Have there been any significant valuation changes in the properties, either appreciations or depreciations?"
]
...
if __name__ == '__main__':
    ...
    clear_tables(engine, responses_table, organizations_table, persons_table, locations_table)
